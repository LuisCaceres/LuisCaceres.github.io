...
const charts = [
  ...
  /* chart  7 */ new Chart('All Star', 'Angels', 'Mi Chico Latino', 'I Need To Know', "That's The Way It Is", 'New', "Someday We'll Know", 'Si Me Advertí', '!Efqfdif!Npef!!!Cbssfm!Pg!B!Hvo!', 'Someday', '!V3!!!Ejtdpuifrvf!', 'Man! I Feel Like A Woman', 'Puente', '!Npotubst!)C!Sfbm-!Cvtub!Siznft-!Dppmjp-!MM!Dppm!K…Nfuipe!Nbo*!!!Iju!(Fn!Ijhi!)Uif!Npotubst!Bouifn*!', 'No Quiero Verte', '!Xbssfo!H/!!!J!Tipu!Uif!Tifsjgg!', 'Fast As You Can', 'All I Have To Give', "Don't Say You Love Me", 'Blue Monday'),
];
