...
class Chart extends List {
  ...
  format(database) {
    ...
    // FILTER 1:  ANY ENTRIES DEBUTING AT POSITION 12 OR LOWER
    // FILTER 2:  ANY ENTRIES EXITING FROM POSITION 12 OR LOWER
    // FILTER 3:  ANY ENTRIES STARTING TO MOVE UNEXPECTEDLY BACKWARDS AFTER THEY'VE BEEN MOVING FORWARDS FOR LESS THAN N WHAT IS THIS NUMBER? NUMBER OF WEEKS
    // FILTER 4:  ANY ENTRIES EXITING WITHOUT A BACKWARDS MOVEMENT AND A DEBUT OCCURS AT A HIGHER POSITION
    // FILTER 5:  ANY ENTRIES IN THE SAME POSITION FOR 3 WEEKS (EXCEPT POSITION 1)  
